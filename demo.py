...
DATA_FOLDERNAME = '/home/pi/gphoto/PhotometricCameraControl/data/2020-05-08@09:08:35piShots/'    # Lambertian diffuse with cast shadow
#DATA_FOLDERNAME = './data/bunny/bunny_lambert_noshadow/'    # Lambertian diffuse without cast shadow

LIGHT_FILENAME = './lights.txt'
...
rps.load_images(foldername=DATA_FOLDERNAME,ext='JPG')    # Load observations
start = time.time()
